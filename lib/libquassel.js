        ...
        for (k in Network.list) {
            ...
            for (l in buffers) {
                var slist = [
                    ...
                    new qtdatastream.QString("BacklogManager"),
                    new qtdatastream.QString(""),
                    new qtdatastream.QString("requestBacklog"),
                    new qtdatastream.QUserType("BufferId", buffers[l].id),
                    new qtdatastream.QUserType("MsgId", -1),
                    new qtdatastream.QUserType("MsgId", -1),
                    new qtdatastream.QVariant(new qtdatastream.QInt(50)),
                    new qtdatastream.QVariant(new qtdatastream.QInt(0))
                ];
                var writer = new Writer(slist);
